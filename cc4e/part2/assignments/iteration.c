/*
This assignment will add an iterator to your Map class. There is a good deal of discussion of iterators in 
the lecture materials associated with this assignment. A good starting point for this assignment is the 
code used for the previous assignment. This assignment will add a new feature to the previous assignment.
*/
